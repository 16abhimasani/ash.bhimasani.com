...
import classes from "./bp-logo.module.scss";
...
const BitpayLogo: React.FC<{ solo?: boolean; payMode?: boolean }> = ({
  solo,
  payMode = false,
}) => (
  <>
    ...
    >
      ...
      >
        <path
          id="i_DOT"
          d="M169.444,86.172l.631-2.672h-4.144l-.631,2.672Z"
          transform="translate(-161.219 -83.5)"
        />
        <path
          id="i_BODY"
          d="M149.56,104.6l-3.66,15.357h4.144l3.639-15.357Z"
          transform="translate(-145.9 -100.161)"
        />
      </motion.g>
      <motion.path
        initial="show"
