    ...
    <motion.main className="body" {...fadeInPage}>
      ...
      <div className="lead begin-section mb-0 end-section">
        <p>
          ...
          circumstances of this project left us on a extremely tight time frame
          to finalize requirements, create designs, and then build it all out.
        </p>
        <p>
          ...
          could be dropped into our payment gateway (Invoice). This would allow
          us to meet our risk management for high value invoices while
        ...
        <p>
          ...
          Directory all allowed me to have a better grasp on what direction our
          brand was heading. Ultimately, I chose to go down a neutral, minimal
          path that would allow us to shape the visual identity of the product
          over time while also being simple at a component level.
        </p>
      </div>
      ...
      <div className="lead begin-section end-section">
        ...
        <p>
          ...
          Email Verification. Verifying a user's email, while typically annoying
          when trying a new service, is an essential part of keeping the
          platform secure. When we issue refunds, we have to know that the
          user's email is valid so we don't accidentally send money to the wrong
          person (this is crypto after all).
        </p>
      </div>
      ...
      <div className="lead begin-section end-section">
        <p>
          ...
          KYC and we knew a deeper integration between the mobile wallet and the
          debit card was coming soon.
        </p>
        <p>
          ...
          header to the bottom and top respectively was all that was needed for
          a responsive layout.
        </p>
      </div>
      <div className="d-flex">
      ...
      <div className="lead begin-section end-section">
        ...
        <p>
          The only major downside to this is changing the optimal clicks from 1
          to 2. Where 1 click can be achieved when the user has their
