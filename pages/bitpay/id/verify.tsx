    ...
    <motion.main className="body" {...fadeInPage}>
      ...
      <div className="lead begin-section mb-0 end-section">
        <p>
          ...
          KYC is generally a huge friction point; it can still be made
          convenient.
        </p>
        <p>
      ...
      <div className="lead begin-section end-section">
        ...
        <p>
          ...
          significantly improved the experience while decreasing the error rate
          of manual user entry.
        </p>
        <p>
      ...
      <div className="lead begin-section end-section">
        ...
        <p>
          ...
          we have to manage both clarity and comfort to make sure we don't spook
      ...
      <div className="lead begin-section end-section">
        <p>
          ...
          learning opportunity for me as a designer and engineer. It was my
          first time really getting into the weeds and working on a highly
          dynamic project with a plethora of experience problems to solve. Many
          parts of the design turned out to be a success but I am still looking
          forward to directly tackling some of the core issues still present
          with a full upgrade.
        </p>
      </div>
