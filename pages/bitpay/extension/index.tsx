    ...
    <motion.main className="body" {...fadeInPage}>
      ...
      <div className="lead end-section">
        <p>
          ...
          checkout experience as you shop. Either alerting you of direct crypto
          acceptance or ability to purchase store credit.
        </p>
      ...
      <div className="lead end-section">
        <p>
          ...
          your personal information and transaction data is kept private from
          the merchant.
        </p>
        <p>
      ...
      <div className="lead end-section">
        <p>
          ...
          for people to discover brands and find out how to use crypto. Over the
          last year, the "BitPay Directory" has been gaining a lot more traction
          with our partners. Naturally we were looking for ways to take the
        ...
        <p>
          ...
          card service and promote brand discovery. We already sold gift cards
          in our mobile wallet for a few years now but we needed to bring this
          capability to the desktop. With the recent acquisition of
          <Anchor
            content="Honey"
