  ...
  <motion.main className="body" {...fadeInPage}>
    ...
    <div className="lead begin-section end-section">
      <p>
        ...
        earliest personal projects when I joined BitPay. I am a heavy email user
        so our old email templates were one of the first things I noticed could
        be improved upon.
      </p>
      <p>
    ...
    <div className="lead begin-section end-section">
      ...
      <p>
        ...
        style to both the Consumer Dashboard and the Invoice. Its interesting to
        see how low impact experimentation can lead a foundational shift
    ...
    <div className="lead begin-section end-section">
      <p>
        When I first started my internship at BitPay, these were the emails that
        were being used in production. Once I went pro, I got tired pretty
        quickly of looking at them so I designed some new ones. I looked at the
        emails sent out by Robinhood, Cash App, Coinbase, and more to create a
        "modern" baseline.
      </p>
      <p>
